...
<c:url value="/users/records.do" var="recordsUrl"/>
<c:url value="/users/create.do" var="addUrl"/>
<c:url value="/users/update.do" var="editUrl"/>
<c:url value="/users/delete.do" var="deleteUrl"/>
